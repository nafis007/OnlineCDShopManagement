<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cd_update.aspx.cs" Inherits="cd_update" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
        ...
        <asp:DropDownList ID="DropDownList1" runat="server">
            ...
            <asp:ListItem>import_date</asp:ListItem>
            <asp:ListItem>cd_name</asp:ListItem>
            <asp:ListItem>price</asp:ListItem>
            <asp:ListItem>category_id</asp:ListItem>
            <asp:ListItem>genre_id</asp:ListItem>
            <asp:ListItem>artist_lastname</asp:ListItem>
            <asp:ListItem>artist_firstname</asp:ListItem>
            <asp:ListItem>director_lastname</asp:ListItem>
            <asp:ListItem>director_firstname</asp:ListItem>
            <asp:ListItem>company</asp:ListItem>
            <asp:ListItem>release_date</asp:ListItem>
