<%@ Page Language="C#" AutoEventWireup="true" CodeFile="software_cds.aspx.cs" Inherits="software_cds" %>
...
<body>
    ...
    <div style="height: 471px; width: 1009px">
    
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:soft_category %>" ProviderName="<%$ ConnectionStrings:soft_category.ProviderName %>" SelectCommand="select * from cd_collection where category_id=4"></asp:SqlDataSource>
