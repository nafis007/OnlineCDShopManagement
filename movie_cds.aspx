<%@ Page Language="C#" AutoEventWireup="true" CodeFile="movie_cds.aspx.cs" Inherits="movie_cds" %>
...
<body>
    ...
    <div style="height: 423px; width: 1265px">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:movie_category_not_games %>" ProviderName="<%$ ConnectionStrings:movie_category_not_games.ProviderName %>" SelectCommand="select * from cd_collection where category_id=2"></asp:SqlDataSource>
