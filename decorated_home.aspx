    ...
    <section id="main-slider" class="no-margin">
        <div class="carousel slide">
            <div class="carousel-inner">
                ...
                <div class="item active" style="background-image: url(images/slider/home.jpeg)">
                    <div class="container">
                        <div class="row slide-margin">
                            <div class="col-sm-10">
                                <div class="carousel-content" style="color: #000000">
                                    
                                    <h1 class="animation animated-item-1">&nbsp;</h1>
                                    <h1 class="animation animated-item-1">&nbsp;</h1>
                                    <h1 class="animation animated-item-1">&nbsp;</h1>
                                    <h1 class="animation animated-item-1">NP CD Shop: an online store for excuisite CDs!&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </h1>
                                    <p class="animation animated-item-1">&nbsp;</p>
                ...
                <div class="item" style="background-image: url(images/slider/bg2_2.jpg)">
                    <div class="container">
                        <div class="row slide-margin">
                            <div class="col-sm-6">
                                <div class="carousel-content">
                                    <h1 class="animation animated-item-1">a wide array of good music is just a click away!</h1>
                ...
                <div class="item" style="background-image: url(images/slider/bg_movie.png)">
                    <div class="container">
                        <div class="row slide-margin">
                            <div class="col-sm-6">
                                <div class="carousel-content">
                                    <h1 class="animation animated-item-1">order HD and blu ray movies for a nice evening!</h1>
                ...
                <div class="item" style="background-image: url(images/slider/bg_soft2.jpg)">
                    <div class="container">
                        <div class="row slide-margin">
                            <div class="col-sm-6">
                                <div class="carousel-content">
                                    <h1 class="animation animated-item-1">need softwares?<br> we have 'em!</h1>
                  ...
                  <div class="item" style="background-image: url(images/slider/bg_games2.jpg)">
                    <div class="container">
                        <div class="row slide-margin">
                            <div class="col-sm-6">
                                <div class="carousel-content">
                                    <h1 class="animation animated-item-1">when was the last time<br> you took the dust off your console?</h1>
                        ...
                        <div class="panel-group" id="accordion1">
                          <div class="panel panel-default">
                            <div class="panel-heading active">
                              <h3 class="panel-title">
                                  Created by<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion1" href="#collapseOne1">
                            ...
                            <div id="collapseOne1" class="panel-collapse collapse in">
                              <div class="panel-body">
                                  <div class="media accordion-inner">
                                        <div class="pull-left">
                                            &nbsp;</div>
                                        Taufiq Islam Protick &amp; Md. Nafis Ul Islam</div>
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="panel panel-default">
                            <div class="panel-heading">
                              <h3 class="panel-title">
                                  session<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion1" href="#collapseTwo1">
                                  <i class="fa fa-angle-right pull-right"></i>
                                </a>
                              </h3>
                            </div>
                          ...
                          <div class="panel panel-default">
                            ...
                            <div id="collapseThree1" class="panel-collapse collapse">
                              <div class="panel-body">
                                &copy nafis_084 <br> &copy protick_062
                              </div>
                            </div>
                          </div>
