            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse navbar-right">
                    <ul class="nav navbar-nav">
                        <li class="active"><a href="mypage.aspx">Home</a></li>
                       <li><a href="portfolio.aspx">audio</a></li>
                        <li><a href="services.aspx">movies</a></li>                        
                       <!-- <li class="dropdown">
                        ...
                        <li><a href="contactus.aspx">softwares</a></li> 
                        <li><a href="contactus.aspx">games</a></li> 
                        <li><a href="contactus.aspx">log in</a></li> 
                         <li><a href="contactus.aspx">signup</a></li> 
